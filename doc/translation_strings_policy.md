...
This document provides guidelines for internationalization of the WIKI Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wiki_en.ts` remains unchanged.
