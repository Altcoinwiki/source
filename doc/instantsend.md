...
This mechanism has been integrated into Bitcore-Node-WIKI which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wikicrypto/insight-api-wiki#web-socket-api](https://github.com/wikicrypto/insight-api-wiki#web-socket-api)
* API: [https://github.com/wikicrypto/insight-api-wiki#instantsend-transactions](https://github.com/wikicrypto/insight-api-wiki#instantsend-transactions)
...
By default, the WIKI Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the WIKI Core daemon:
