...
unlocked to sign the WIKI-Qt.app bundle.
...
allowing somebody to distribute a WIKI-Qt.app or wiki-qt-setup.exe with a valid
...
that the wiki-qt.exe file inside the installer had not been tampered with.
