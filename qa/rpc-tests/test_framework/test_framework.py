...
class WIKITestFramework(object):
...
# Test framework for doing p2p comparison testing, which sets up some wikid
# binaries:
# 1 binary: test binary
# 2 binaries: 1 test binary, 1 ref binary
# n>2 binaries: 1 test binary, n-1 ref binaries

class ComparisonTestFramework(WIKITestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          ...
                          help="wikid binary to test")
        parser.add_option("--refbinary", dest="refbinary",
                          default=os.getenv("WIKID", "wikid"),
                          help="wikid binary to use for reference nodes (if any)")
