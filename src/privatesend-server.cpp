...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all WIKI related functionality
...
/*
    ...
    allow endless transaction that would bloat WIKI and make it unusable. To
