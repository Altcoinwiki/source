 ...
 * for both wikid and wiki-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("WIKI Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/wiki/bips/blob/master/bip-0014.mediawiki) 
 */
