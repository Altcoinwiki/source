...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CWIKIAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CWIKIAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CWIKIAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CWIKIAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CWIKIAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CWIKIAddress(arr[0].get_str()).Get() == demoAddress.Get());
