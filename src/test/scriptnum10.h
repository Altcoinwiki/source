...
#ifndef WIKI_TEST_SCRIPTNUM10_H
#define WIKI_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from WIKI Core 0.10.0, for cross-comparison.
 */
public:
