    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextWIKI   = QChar(0xA9)+QString(" 2018 ").arg(COPYRIGHT_YEAR) + QString(tr("Developed by WikiCoin Developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace,copyrightTextWIKI);
