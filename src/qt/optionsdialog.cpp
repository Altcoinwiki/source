    ...
    mapper(0)
{
    ...
    ui->theme->addItem(QString("WIKI-light-hires"), QVariant("light-hires"));
    ...
    ui->unit->setModel(new WIKIUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->wikiAtStartup, OptionsModel::StartAtStartup);
