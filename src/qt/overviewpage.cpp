...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(WIKIUnits::WIKI),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = WIKIUnits::floorWithUnit(unit, amount, true, WIKIUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, WIKIUnits::separatorAlways));
    ui->labelUnconfirmed->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, WIKIUnits::separatorAlways));
    ui->labelImmature->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, WIKIUnits::separatorAlways));
    ui->labelAnonymized->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, WIKIUnits::separatorAlways));
    ui->labelTotal->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, WIKIUnits::separatorAlways));
    ui->labelWatchAvailable->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, WIKIUnits::separatorAlways));
    ui->labelWatchPending->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, WIKIUnits::separatorAlways));
    ui->labelWatchImmature->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, WIKIUnits::separatorAlways));
    ui->labelWatchTotal->setText(WIKIUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, WIKIUnits::separatorAlways));
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = WIKIUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, WIKIUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), WIKIUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = WIKIUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, WIKIUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), WIKIUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(WIKIUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(WIKIUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
