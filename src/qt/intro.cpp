...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || dataDirDefaultCurrent != dataDirDefaultSettings)
    {
        ...
        intro.setWindowIcon(QIcon(":icons/wiki"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("WIKI Core"),
     ...
     * override -datadir in the wiki.conf file in the default data directory
     * (to be consistent with wikid behavior)
     */
