...
#ifndef WIKI_QT_WIKIUNITS_H
#define WIKI_QT_WIKIUNITS_H
...
/** WIKI unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WIKIUnits: public QAbstractListModel
{
    Q_OBJECT
...
typedef WIKIUnits::Unit WIKIUnit;

#endif // WIKI_QT_WIKIUNITS_H
