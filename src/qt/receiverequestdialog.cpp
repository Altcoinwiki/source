...
#include "config/wiki-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatWIKIURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + WIKIUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatWIKIURI(info));
}
